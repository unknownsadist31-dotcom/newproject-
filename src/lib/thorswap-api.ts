...
const THORSWAP_API = 'https://api.thorswap.net/aggregator/tokens/quote'
const THORSWAP_TOKENLIST = 'https://api.thorswap.net/tokenlist'
const MIDGARD_API = 'https://gateway.liquify.com/chain/thorchain_midgard'
const THORNODE_API = 'https://gateway.liquify.com/chain/thorchain_api'
